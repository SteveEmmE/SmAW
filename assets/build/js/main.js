...
/* harmony import */ var lightslider_dist_js_lightslider__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! lightslider/dist/js/lightslider */ "./node_modules/lightslider/dist/js/lightslider.js");
/* harmony import */ var lightslider_dist_js_lightslider__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(lightslider_dist_js_lightslider__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var lightslider_dist_css_lightslider_css__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! lightslider/dist/css/lightslider.css */ "./node_modules/lightslider/dist/css/lightslider.css");
...
if (jQuery('.rellax').length != 0) {
  var rellax = new (rellax__WEBPACK_IMPORTED_MODULE_5___default())('.rellax', {});
}
/**
 * Fixed Top Bar
 */
...
jQuery(document).ready(function () {
  if (jQuery(window).scrollTop() >= jQuery('.top-banner').outerHeight()) jQuery('.navbar').addClass('fixed');else jQuery('.navbar').removeClass('fixed');
});
jQuery(window).scroll(function () {
  if (jQuery(this).scrollTop() >= jQuery('.top-banner').outerHeight()) jQuery('.navbar').addClass('fixed');else jQuery('.navbar').removeClass('fixed');
});
/**
 * Fixed category bar
 */
...
jQuery(document).ready(function () {
  if (jQuery(window).scrollTop() >= jQuery('.top-banner').outerHeight() + jQuery('.categories-slider-fixed-trigger').outerHeight()) jQuery('.category-slider').addClass('category-slider-fixed');else jQuery('.category-slider').removeClass('category-slider-fixed');
});
jQuery(window).scroll(function () {
...
var sliders = jQuery('.image-container');
Array.from(jQuery(sliders)).forEach(function (slider) {
  var slides = Array.from(jQuery(slider).find('img'));
...
Array.from(jQuery('.lightSlider')).forEach(function (s) {
  var items = jQuery(s).data('items');
  var responsiveBreakpoints = jQuery(s).data('breakpoints');
  jQuery(s).lightSlider({
    ...
    speed: 600,
    responsive: responsiveBreakpoints.map(function (rb) {
      return {
        breakpoint: rb.value,
        settings: {
          item: rb.itemsNumber,
...
var md = 720; // Menu Position

var topMenu = jQuery('.top-menu');
var topBannerInfo = jQuery('.top-banner__info');
