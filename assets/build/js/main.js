...
jQuery(document).ready(function () {
  if (jQuery(window).scrollTop() >= jQuery('.top-banner').height()) jQuery('.navbar').addClass('fixed');else jQuery('.navbar').removeClass('fixed');
});
jQuery(window).scroll(function () {
  if (jQuery(this).scrollTop() >= jQuery('.top-banner').height()) jQuery('.navbar').addClass('fixed');else jQuery('.navbar').removeClass('fixed');
});
/**
 * Image Sliders
 */
